...
def handle_image_message(event):
    ...
    img1 = image.load_img("static/"+event.message.id+"-1.jpg", grayscale=False, target_size=(28, 28))
    img2 = image.load_img("static/"+event.message.id+"-2.jpg", grayscale=False, target_size=(28, 28))
    img3 = image.load_img("static/"+event.message.id+"-3.jpg", grayscale=False, target_size=(28, 28))
    img4 = image.load_img("static/"+event.message.id+"-4.jpg", grayscale=False, target_size=(28, 28))
